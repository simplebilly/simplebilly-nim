...
import ../models/model_datev_import_response
...
proc datevImportApi*(httpClient: HttpClient, body: JsonNode): (Option[DatevImportResponse], Response) =
  ## 
  httpClient.headers["Content-Type"] = "application/json"

  let response = httpClient.post(basepath & "/api/v1/bookkeeping/datev/import", $(%body))
  constructResult[DatevImportResponse](response)
