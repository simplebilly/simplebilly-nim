...
import ../models/model_eks_ergebnis
...
proc eksApi*(httpClient: HttpClient, year: int): (Option[EksErgebnis], Response) =
  ## 
  var query_params_list: seq[(string, string)] = @[]
  query_params_list.add(("year", $year))
  let url_encoded_query_params = encodeQuery(query_params_list)

  let response = httpClient.get(basepath & "/api/v1/bookkeeping/eks" & "?" & url_encoded_query_params)
  constructResult[EksErgebnis](response)
