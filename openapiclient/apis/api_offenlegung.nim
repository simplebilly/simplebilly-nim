...
import ../models/model_offenlegung_report
...
proc offenlegungApi*(httpClient: HttpClient): (Option[OffenlegungReport], Response) =
  ## 

  let response = httpClient.get(basepath & "/api/v1/bookkeeping/offenlegung")
  constructResult[OffenlegungReport](response)
