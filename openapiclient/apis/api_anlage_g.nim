...
import ../models/model_anlage_g_ergebnis
...
proc anlageGApi*(httpClient: HttpClient, year: int): (Option[AnlageGErgebnis], Response) =
  ## 
  var query_params_list: seq[(string, string)] = @[]
  query_params_list.add(("year", $year))
  let url_encoded_query_params = encodeQuery(query_params_list)

  let response = httpClient.get(basepath & "/api/v1/bookkeeping/anlage-g" & "?" & url_encoded_query_params)
  constructResult[AnlageGErgebnis](response)
