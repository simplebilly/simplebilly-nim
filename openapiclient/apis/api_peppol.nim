...
import ../models/model_peppol_response
...
proc peppolApi*(httpClient: HttpClient, id: string): (Option[PeppolResponse], Response) =
  ## 

  let response = httpClient.get(basepath & fmt"/api/v1/invoices/{id}/peppol")
  constructResult[PeppolResponse](response)
