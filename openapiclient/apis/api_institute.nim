...
import ../models/model_institute_status
...
proc instituteStatusApi*(httpClient: HttpClient): (Option[InstituteStatus], Response) =
  ## 

  let response = httpClient.get(basepath & "/api/v1/bookkeeping/institute/status")
  constructResult[InstituteStatus](response)
