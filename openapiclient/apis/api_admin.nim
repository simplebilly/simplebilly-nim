...
import ../models/model_mirror_trigger_response
...
proc triggerMirror*(httpClient: HttpClient): (Option[MirrorTriggerResponse], Response) =
  ## 

  let response = httpClient.post(basepath & "/api/v1/admin/storage/mirror")
  constructResult[MirrorTriggerResponse](response)
