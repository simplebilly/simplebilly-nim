...
import ../models/model_payment_condition
...
proc listPaymentConditionsApi*(httpClient: HttpClient): (Option[seq[PaymentCondition]], Response) =
  ## 

  let response = httpClient.get(basepath & "/api/v1/payment-conditions")
  constructResult[seq[PaymentCondition]](response)
