...
import ../models/model_oss_report
...
proc ossReportApi*(httpClient: HttpClient): (Option[OssReport], Response) =
  ## 

  let response = httpClient.get(basepath & "/api/v1/bookkeeping/oss")
  constructResult[OssReport](response)
