...
import ../models/model_kosten_vorschau
...
proc kostenVorschauApi*(httpClient: HttpClient, year: int, month: int): (Option[KostenVorschau], Response) =
  ## 
  ...
  let response = httpClient.get(basepath & "/api/v1/bookkeeping/kosten-vorschau" & "?" & url_encoded_query_params)
  constructResult[KostenVorschau](response)
