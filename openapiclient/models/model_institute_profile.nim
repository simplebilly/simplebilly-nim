...
import model_institute_type

type InstituteProfile* = object
  ## 
  instituteType*: Option[InstituteType] ## Institutsart: \"kein\" | \"kreditinstitut\" | \"finanzdienstleistungsinstitut\" | \"finanzunternehmen\" | \"versicherung\".
  kapitalmarktorientiert*: Option[bool] ## Kapitalmarktorientierung (§ 325 Abs. 4 HGB): Offenlegungsfrist 4 statt 12 Monate.
