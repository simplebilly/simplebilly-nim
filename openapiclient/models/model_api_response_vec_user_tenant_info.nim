...
import model_api_response_vec_user_tenant_info_data_inner

type ApiResponseVecUserTenantInfo* = object
  ## 
  data*: Option[seq[ApiResponse_Vec_UserTenantInfo_data_inner]]
  error*: Option[string]
