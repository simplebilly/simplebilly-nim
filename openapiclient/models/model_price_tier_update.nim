...
type PriceTierUpdate* = object
  ## 
  customerGroupId*: Option[string] ## None = tier applies to all customers; otherwise a customer group id.
  minQuantity*: Option[int64] ## Quantity from which this tier applies (inclusive).
  productId*: Option[string] ## References the product entity.
