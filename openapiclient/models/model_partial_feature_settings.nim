...
type PartialFeatureSettings* = object
  ## Partial feature toggles: `None` keeps the company-type default, `Some` overrides it.
  onlineshop*: Option[bool]
  reportBilanz*: Option[bool]
  reportBwa*: Option[bool]
  reportEuer*: Option[bool]
  reportGewerbesteuer*: Option[bool]
  reportGuv*: Option[bool]
  reportKst*: Option[bool]
  reportUstva*: Option[bool]
