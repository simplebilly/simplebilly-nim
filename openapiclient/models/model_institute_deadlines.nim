...
type InstituteDeadlines* = object
  ## 
  abschlusspruefungMonths*: Option[int] ## HGB § 340k/§ 341k: Abschlussprüfung (5 Monate).
  jahresabschlussBafinMonths*: Option[int] ## KWG § 26: Jahresabschluss an die BaFin (3 Monate, nur KWG-Institute).
  offenlegungMonths*: int ## HGB § 325 Abs. 4: Offenlegung (4 kapitalmarktorientiert / 12 sonst).
