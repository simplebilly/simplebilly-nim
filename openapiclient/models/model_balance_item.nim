...
# Custom JSON deserialization for BalanceItem with custom field names
proc to*(node: JsonNode, T: typedesc[BalanceItem]): BalanceItem =
  result = BalanceItem()
...
# Custom JSON serialization for BalanceItem with custom field names
proc `%`*(obj: BalanceItem): JsonNode =
  result = newJObject()
