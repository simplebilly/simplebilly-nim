...
# Custom JSON deserialization for Team with custom field names
proc to*(node: JsonNode, T: typedesc[Team]): Team =
  result = Team()
...
# Custom JSON serialization for Team with custom field names
proc `%`*(obj: Team): JsonNode =
  result = newJObject()
